...
struct ImmutableDBOptions {
  ...
  std::shared_ptr<std::vector<QuicksandMetrics>> job_stats; // 记录 Compaction 操作的详细性能和状态数据
  std::shared_ptr<std::vector<FlushMetrics>> flush_stats; // 记录 Flush 操作的详细性能和状态数据
